...
/*
// Something I was working on. I hate preprocessor macros but I couldn't
// find a better way to do this so I decided to not include it.
#define delay(x) if(x) { delay_time = world.time + (x) } else if(world.time < delay_time) { return }
*/

mob
	/*
	// This is related to the preprocessor macro
	// var/delay_time = 0
	*/
